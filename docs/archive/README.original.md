> ⚠️ **ARKIVERT DOKUMENTASJON**
>
> Dette er den opprinnelige README-filen for OSEBERG_Proff, bevart for historikk.
> Den er **utdatert** (beskriver bl.a. .NET 6-versjonen og det gamle dev-miljøet
> `suran.crm4`). Gjeldende, vedlikeholdt dokumentasjon ligger i [`/README.md`](../../README.md)
> i rota av repoet.
>
> Arkivert: 2026-06-08.
...
# Introduksjon (opprinnelig README)
